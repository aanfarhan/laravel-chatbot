      ...
      '/decisions/': [
        {
          ...
          items: [
            ...
            { text: 'ADR-0005 — Blade snapshot rides the extractor pipeline', link: '/adr/0005-blade-snapshot-rides-the-client-extractor-pipeline' },
            { text: 'ADR-0006 — Advisory tool timeouts, not hard interruption', link: '/adr/0006-advisory-tool-timeouts-not-hard-interruption' },
            { text: 'ADR-0007 — PHP 8.2 is the minimum supported version', link: '/adr/0007-php-82-minimum-for-wider-reach' },
          ],
        },
      ],
    },
